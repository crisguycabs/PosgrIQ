                ...
                try
                {
                    switch (cmbVer.SelectedIndex)
                    {
                        ...
                        case 1: // concepto 1 calificador 1
                            System.Diagnostics.Process.Start(padre.sourceONE + "\\Soportes\\" + Convert.ToString(dtTesisDoct.Rows[0][15]));
                            break;
                        case 2: // concepto 1 calificador 2
                            System.Diagnostics.Process.Start(padre.sourceONE + "\\Soportes\\" + Convert.ToString(dtTesisDoct.Rows[0][16]));
                            break;
                        case 3: // concepto 1 calificador 3
                            System.Diagnostics.Process.Start(padre.sourceONE + "\\Soportes\\" + Convert.ToString(dtTesisDoct.Rows[0][17]));
                            break;
                        case 4: // concepto 1 calificador 4
                            System.Diagnostics.Process.Start(padre.sourceONE + "\\Soportes\\" + Convert.ToString(dtTesisDoct.Rows[0][18]));
                            break;
                        case 5: // concepto 1 calificador 5
                            System.Diagnostics.Process.Start(padre.sourceONE + "\\Soportes\\" + Convert.ToString(dtTesisDoct.Rows[0][19]));
                            break;
                        case 6: // concepto 2 calificador 1
                            System.Diagnostics.Process.Start(padre.sourceONE + "\\Soportes\\" + Convert.ToString(dtTesisDoct.Rows[0][26]));
                            break;
                        case 7: // concepto 2 calificador 2
                            System.Diagnostics.Process.Start(padre.sourceONE + "\\Soportes\\" + Convert.ToString(dtTesisDoct.Rows[0][27]));
                            break;
                        case 8: // concepto 2 calificador 3
                            System.Diagnostics.Process.Start(padre.sourceONE + "\\Soportes\\" + Convert.ToString(dtTesisDoct.Rows[0][28]));
                            break;
                        case 9: // concepto 2 calificador 4
                            System.Diagnostics.Process.Start(padre.sourceONE + "\\Soportes\\" + Convert.ToString(dtTesisDoct.Rows[0][29]));
                            break;
                        case 10: // concepto 2 calificador 5
                            System.Diagnostics.Process.Start(padre.sourceONE + "\\Soportes\\" + Convert.ToString(dtTesisDoct.Rows[0][30]));
                            break;
