...
namespace PosgrIQ
{
    public partial class AddPropuestaMaesForm : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (!System.IO.Directory.Exists(padre.sourceONE + "\\Soportes\\PropuestasMaestria\\" + folderEst))
            {
            ...
            if (!System.IO.Path.GetFileName(txtRutaPropuesta.Text).Contains("ac1017")) // no contienen la cadena => no es necesario verificar
            {
                try
                {
                    System.IO.File.Copy(txtRutaPropuesta.Text, padre.sourceONE + "\\Soportes\\PropuestasMaestria\\" + destino, true);
                }
                catch
                {
            ...
            if (!string.IsNullOrWhiteSpace(txtRutaConcepto1Calificador1.Text))
            {
                ...
                if (!System.IO.Path.GetFileName(txtRutaConcepto1Calificador1.Text).Contains("ac1017")) // no contienen la cadena => es necesario verificar
                {
                    try
                    {
                        System.IO.File.Copy(txtRutaConcepto1Calificador1.Text, padre.sourceONE + "\\Soportes\\PropuestasMaestria\\" + destinoC1C1, true);
                    }
                    catch
                    {
            ...
            if (!string.IsNullOrWhiteSpace(txtRutaConcepto1Calificador2.Text))
            {
                ...
                if (!System.IO.Path.GetFileName(txtRutaConcepto1Calificador2.Text).Contains("ac1017")) // no contienen la cadena => es necesario verificar
                {
                    try
                    {
                        System.IO.File.Copy(txtRutaConcepto1Calificador2.Text, padre.sourceONE + "\\Soportes\\PropuestasMaestria\\" + destinoC1C2, true);
                    }
                    catch
                    {
            ...
            if (!string.IsNullOrWhiteSpace(txtRutaConcepto2Calificador1.Text))
            {
                ...
                if (!System.IO.Path.GetFileName(txtRutaConcepto2Calificador1.Text).Contains("ac1017")) // no contienen la cadena => es necesario verificar
                {
                    try
                    {
                        System.IO.File.Copy(txtRutaConcepto2Calificador1.Text, padre.sourceONE + "\\Soportes\\PropuestasMaestria\\" + destinoC2C1, true);
                    }
                    catch
                    {
            ...
            if (!string.IsNullOrWhiteSpace(txtRutaConcepto2Calificador2.Text))
            {
                ...
                if (!System.IO.Path.GetFileName(txtRutaConcepto2Calificador2.Text).Contains("ac1017")) // no contienen la cadena => es necesario verificar
                {
                    try
                    {
                        System.IO.File.Copy(txtRutaConcepto2Calificador2.Text, padre.sourceONE + "\\Soportes\\PropuestasMaestria\\" + destinoC2C2, true);
                    }
                    catch
                    {
            ...
            if (!string.IsNullOrWhiteSpace(txtRutaSustentacion.Text))
            {
                ...
                if (!System.IO.Path.GetFileName(txtRutaSustentacion.Text).Contains("ac1017")) // no contienen la cadena => es necesario verificar
                {
                    try
                    {
                        System.IO.File.Copy(txtRutaSustentacion.Text, padre.sourceONE + "\\Soportes\\PropuestasMaestria\\" + destinoActa, true);
                    }
                    catch
                    {
            ...
            switch (modo)
            {
                case true:
                    ...
                    try
                    {
                        ...
                        query += ", ruta";
                        query2 += ", 'PropuestasMaestria\\" + destino + "'";
                        ...
                        if (!string.IsNullOrWhiteSpace(txtRutaConcepto1Calificador1.Text))
                        {
                            ...
                            query2 += ", 'PropuestasMaestria\\" + destinoC1C1 + "'";
                        }

                        if (!string.IsNullOrWhiteSpace(txtRutaConcepto1Calificador2.Text))
                        {
                            query += ", rutaconcepto1calificador2";
                            query2 += ", 'PropuestasMaestria\\" + destinoC1C2 + "'";
                        }
                        ...
                        if (chkCorrecciones.Checked)
                        {
                            ...
                            if (!string.IsNullOrWhiteSpace(txtRutaConcepto2Calificador1.Text))
                            {
                                ...
                                query2 += ", 'PropuestasMaestria\\" + destinoC2C1 + "'";
                            }

                            if (!string.IsNullOrWhiteSpace(txtRutaConcepto2Calificador2.Text))
                            {
                                query += ", rutaconcepto2calificador2";
                                query2 += ", 'PropuestasMaestria\\" + destinoC2C2 + "'";
                            }
                        }
                        else
                        {
                        ...
                        if (chkSustentacion.Checked)
                        {
                            ...
                            if (!string.IsNullOrWhiteSpace(txtRutaSustentacion.Text))
                            {
                                ...
                                query2 += ", 'PropuestasMaestria\\" + destinoActa + "'";
                            }
                        }
                        else
                        {
                ...
                case false:
                    ...
                    try
                    {
                        ...
                        query += ", ruta='PropuestasMaestria\\" + destino + "'";
                        ...
                        if (cmbConcepto1Calificador1.SelectedIndex >= 0) query += ", concepto1calificador2=" + (cmbConcepto1Calificador2.SelectedIndex + 1).ToString();
                        else query += ", concepto1calificador2=0";

                        if (!string.IsNullOrWhiteSpace(txtRutaConcepto1Calificador1.Text)) query += ", rutaconcepto1calificador1='PropuestasMaestria\\" + destinoC1C1 + "'";

                        if (!string.IsNullOrWhiteSpace(txtRutaConcepto1Calificador2.Text)) query += ", rutaconcepto1calificador2='PropuestasMaestria\\" + destinoC1C2 + "'";
                        ...
                        if (!string.IsNullOrWhiteSpace(txtRutaConcepto2Calificador1.Text)) query += ", rutaconcepto2calificador1='PropuestasMaestria\\" + destinoC2C1 + "'";

                        if (!string.IsNullOrWhiteSpace(txtRutaConcepto2Calificador2.Text)) query += ", rutaconcepto2calificador2='PropuestasMaestria\\" + destinoC2C2 + "'";
                        ...
                        if (!string.IsNullOrWhiteSpace(txtRutaSustentacion.Text)) query += ", rutaconceptofinal='PropuestasMaestria\\" + destinoActa + "'";
