...
namespace PosgrIQ
{
    public partial class AddPonenciasMaesForm : Form
    {
        ...
        private void AddPonenciasMaesForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (modo)
                {
                    case true: // se agrega una nueva publicacion de doctorado
                        ...
                        this.Text = "AGREGAR PONENCIA DE MAESTRIA";
            ...
            {
                MessageBox.Show("No se puede acceder a la base de datos, tabla PonenciasMaes", "Error de conexión", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No se ha ingresado el nombre de la ponencia de maestria", "Falta informacion", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            else
            {
            ...
            {
                MessageBox.Show("No se ha ingresado el nombre del evento de la ponencia de maestria", "Falta informacion", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            else
            {
                ...
                {
                    MessageBox.Show("El titulo del evento de la ponencia de maestria es demasiado.\r\n\r\nMaximo 255 caractereres", "Falta informacion", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
            }
            ...
            {
                MessageBox.Show("No se ha ingresado el alcance de la ponencia de maestria", "Falta informacion", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            switch (modo)
            {
                case true: // se agrega la publicacion
                    ...
                    {
                        MessageBox.Show("No se puede acceder a la base de datos, tabla Ponencias Maestria", "Error de conexión", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    break;
