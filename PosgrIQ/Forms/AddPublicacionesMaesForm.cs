...
namespace PosgrIQ
{
    public partial class AddPublicacionesMaesForm : Form
    {
        ...
        private void AddPublicacionesMaesForm_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No se puede acceder a la base de datos, tabla PublicacionesMaes", "Error de conexión", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            switch (modo)
            {
                case true: // se agrega la publicacion
                    ...
                    {
                        MessageBox.Show("No se puede acceder a la base de datos, tabla Publicaciones Maestria", "Error de conexión", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    break;
                ...
                case false: // se modifica la publicacion
                    ...
                    {
                        MessageBox.Show("No se puede acceder a la base de datos, tabla Publicaciones Maes", "Error de conexión", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
